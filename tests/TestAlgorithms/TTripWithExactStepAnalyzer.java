...
public class TTripWithExactStepAnalyzer {
    ...
    public void setUp() throws Exception {
        ...
        parameters.setEffortValue(4);
        
        algorithm = new TripWithExactStopAnalzyer(graphDataProcessor.processRailwayGraph(GOOD_GRAPH_INPUT));
    }
    ...
    @Test
    public void testComputePossibleTripWithMaxStops() throws NoSuchStationException, NoSuchRouteException {
        String result = algorithm.search(parameters);
        assertEquals("3", result); // ABCDC, ADCDC, ADEBC 
    }
