...
public class TTripByStopsAnalzyer {
    ...
    public void setUp() throws Exception {
        ...
        parameters.setEffortValue(3);
        
        algorithm = new TripWithinStopsAnalzyer(graphDataProcessor.processRailwayGraph(GOOD_GRAPH_INPUT));
    }
    ...
    @Test
    public void testComputePossibleTripWithinhMaxStops() throws NoSuchStationException, NoSuchRouteException {
        String result = algorithm.search(parameters);
        assertEquals("2", result); //CBC CBEC
    }
